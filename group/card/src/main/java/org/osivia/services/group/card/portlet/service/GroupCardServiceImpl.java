...
//            // PortalGroup
    ...
    public void saveGroup(PortalControllerContext portalControllerContext, GroupCardOptions options, GroupEditionForm form) throws PortletException {
        ...
        if (options.isEditable()) {
            ...
            if (group != null) {
                // LDAP properties
                this.setLdapProperties(portalControllerContext, form, group);
...
//        PortalGroup group = this.service.get(options.getDn());
        ...
        //TODO pour tests
        options.setDn(this.service.buildDn("test"));
        Group group = new Group();
        group.setDisplayName("Displayname test");
        ...
        group.setMembers(memberList);
        if (group != null) {
            this.fillLdapProperties(portalControllerContext, form, group);
        }
...
//            deletable = StringUtils.isNotEmpty(this.administratorRole) && this.roleService.hasRole(dn, this.administratorRole);
     ...
     */
    protected void setLdapProperties(PortalControllerContext portalControllerContext, GroupEditionForm form, PortalGroup group) throws PortletException {
     ...
     * @throws PortletException
     */
    protected void fillLdapProperties(PortalControllerContext portalControllerContext, GroupEditionForm form, Group group) throws PortletException {
        ...
        form.setMembers(group.getMembers());
    }
}

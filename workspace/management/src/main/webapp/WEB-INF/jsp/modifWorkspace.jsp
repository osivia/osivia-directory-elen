	...
	<div class="form-group">
			<div class="col-sm-8 col-sm-offset-4">
				...
				<c:if test="${provenance=='consulterEspace'}">
					<a href="${retourEspace}" class="btn btn-default"><i class="glyphicons ban"></i> <span><is:getProperty key="label.btn.annuler"/></span> </a>
	      		</c:if>
	      		<c:if test="${provenance!='consulterEspace'}">
	      			<a href="${retourListe}" class="btn btn-default"><i class="glyphicons ban"></i> <span><is:getProperty key="label.btn.annuler"/></span> </a>

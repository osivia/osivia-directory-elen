    ...
    <form:form action="${saveUrl}" method="post" modelAttribute="userForm" cssClass="form-horizontal" role="form">
        ...
        <spring:bind path="title">
            <div class="form-group">
                <form:label path="title" cssClass="col-sm-4 col-lg-3 control-label"><op:translate
                        key="TITLE"/></form:label>
        ...
        <spring:bind path="lastName">
            <div class="form-group required ${status.error ? 'has-error has-feedback' : ''}">
                <form:label path="lastName" cssClass="col-sm-4 col-lg-3 control-label"><op:translate
                        key="LAST_NAME"/></form:label>
                <div class="col-sm-8 col-lg-9">
        ...
        <spring:bind path="email">
            <div class="form-group required ${status.error ? 'has-error has-feedback' : ''}">
                <form:label path="email" cssClass="col-sm-4 col-lg-3 control-label"><op:translate
        ...
        <c:if test="${userForm.mustChangePassword}">
            ...
            <spring:bind path="password">
                <div class="form-group required ${status.error ? 'has-error has-feedback' : ''}">
                    <form:label path="password" cssClass="col-sm-4 col-lg-3 control-label"><op:translate
            ...
            <spring:bind path="passwordConfirmation">
                <div class="form-group required ${status.error ? 'has-error has-feedback' : ''}">
                    <form:label path="passwordConfirmation" cssClass="col-sm-4 col-lg-3 control-label"><op:translate
